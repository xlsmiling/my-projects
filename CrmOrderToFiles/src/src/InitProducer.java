...
public class InitProducer {
    ...
    public static void initProducer(){
        try {
             ...
             */
            producer = new DefaultMQProducer("CrmMsgGroup");
            ...
            producer.setInstanceName("CrmMsg");
            producer.start();
...
//            System.out.println(sendResult);
     ...
     * @throws java.io.IOException
     */
    public static void sendToMarket(String data){
        try {
            Message msg = new Message("CRMRealTimeBusiSub", "*", data.getBytes());
            producer.send(msg);
        } catch (MQClientException e) {
            e.printStackTrace();
        } catch (RemotingException e) {
